const storedNavigateCardData = localStorage.getItem('NavigateCardData');

export const NavigateCardData = storedNavigateCardData ? JSON.parse(storedNavigateCardData) : [
    {
        title: 'About Us',
...
if (!storedNavigateCardData) {
    localStorage.setItem('NavigateCardData', JSON.stringify(NavigateCardData));
}
